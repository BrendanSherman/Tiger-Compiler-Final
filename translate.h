...
struct TR_Exp_ {
    ...
    union {
        ...
        struct { TR_Exp left; TR_Exp right; A_Oper op; } log;
        struct {
            TR_Exp test;
            TR_Exp true_branch;
            TR_Exp false_branch;
        ...
        struct { TR_Exp num_elements; int element_size; TR_Exp init; } array;
        TR_ExpList  record;
        TR_StmList seq;
    } u;
};
...
extern TR_StmList TR_loop_list;
...
TR_StmList make_TR_StmList(TR_Stm stm);
